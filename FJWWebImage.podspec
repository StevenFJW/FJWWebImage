#
#  Be sure to run `pod spec lint FJWWebImage.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "fengjiwen"
  # s.authors            = { "fengjiwen" => "903683902@qq.com" }
  # s.social_media_url   = "http://twitter.com/fengjiwen"
